          ...
          <Reveal key={v.name} delay={0.1}>
            <div data-testid={`venture-card-${i}`}
              ...
              <div className="md:col-span-5 [direction:ltr]">
                ...
                <p className="text-sm font-bold tracking-[0.25em] uppercase text-[#8ECAE6] mt-3" style={{ color: "#2563EB" }}>{v.type}</p>
                <p className="text-[#475569] leading-relaxed mt-5 max-w-md">{v.desc}</p>
                <span className="pill-btn border-2 border-[#0F172A] text-[#0F172A] px-7 py-3 mt-7 inline-flex items-center gap-2 group-hover:bg-[#0F172A] group-hover:text-white cursor-pointer"
                  data-testid={`venture-link-${i}`}>
